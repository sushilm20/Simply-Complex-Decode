...
public class AutoConstants {
    ...
    public static double startHeading = 321;
    ...
    public static double firstIntakeX = 21;
    public static double secondIntakeX = 16 ;
    ...
    public static double startX = 18.21;
    public static double startY = 119;
